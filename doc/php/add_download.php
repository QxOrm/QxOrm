<html>
<head>
<meta http-equiv="refresh" content="0; url=../version/QxOrm_1.2.7.zip">
<?php
   ...
   */
   ...
   echo "<script type='text/javascript'>document.location.href='../version/QxOrm_1.2.7.zip';</script>";
?>
</head>
<body>
</body>
