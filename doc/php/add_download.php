<html>
<head>
<meta http-equiv="refresh" content="0; url=../version/QxOrm_1.3.2.zip">
<?php
   ...
   */
   ...
   echo "<script type='text/javascript'>document.location.href='../version/QxOrm_1.3.2.zip';</script>";
?>
</head>
<body>
</body>
