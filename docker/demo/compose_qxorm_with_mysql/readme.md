# QxOrm Demo Stack (C++ / Qt / ORM / HTTP Web Server / REST API / MySQL)
...
## Quick start
```
curl -L -O https://raw.githubusercontent.com/QxOrm/QxOrm/master/docker/demo/compose_qxorm_with_mysql/compose_demo_qxorm_with_mysql.yaml
docker compose -f compose_demo_qxorm_with_mysql.yaml up -d
```
...
https://github.com/QxOrm/QxOrm/tree/master/docker/dev/compose_qxorm_with_mysql
