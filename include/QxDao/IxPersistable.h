...
/*!
 * \ingroup QxDao
 * \brief qx::IxPersistableCollection<T>::type : return the collection type used by qx::IxPersistable interface, qx::QxCollection<type_primary_key, std::shared_ptr<my_type>>
 */
template <typename T>
