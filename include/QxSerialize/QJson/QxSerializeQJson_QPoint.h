...
QX_DLL_EXPORT QJsonValue QxConvert_ToJson_Helper(const QPoint & t, const QString & format) BOOST_USED;
QX_DLL_EXPORT qx_bool QxConvert_FromJson_Helper(const QJsonValue & j, QPoint & t, const QString & format) BOOST_USED;
