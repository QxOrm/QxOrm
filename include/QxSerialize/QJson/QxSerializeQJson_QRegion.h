...
QX_DLL_EXPORT QJsonValue QxConvert_ToJson_Helper(const QRegion & t, const QString & format) BOOST_USED;
QX_DLL_EXPORT qx_bool QxConvert_FromJson_Helper(const QJsonValue & j, QRegion & t, const QString & format) BOOST_USED;
