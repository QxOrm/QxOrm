 ...
 */
template <typename T>
struct is_std_shared_ptr : public boost::mpl::false_ { ; };

template <typename T>
struct is_std_shared_ptr< std::shared_ptr<T> > : public boost::mpl::true_ { ; };

template <typename T>
struct is_std_shared_ptr< std::shared_ptr<T> & > : public boost::mpl::true_ { ; };

template <typename T>
struct is_std_shared_ptr< const std::shared_ptr<T> > : public boost::mpl::true_ { ; };
