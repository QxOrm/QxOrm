...
template <> struct QxConvert_FromVariant< QVariant > {
...
static inline qx_bool fromVariant(const QVariant & v, QUuid & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); t = QUuid(v.toString()); return qx_bool(true); } };
...
{ Q_UNUSED(format); Q_UNUSED(index); QString s = v.toString(); t.fromString(s); return qx_bool(true); } };
...
static inline qx_bool fromVariant(const QVariant & v, std::pair<T1, T2> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename T1, typename T2> struct QxConvert_FromVariant< QPair<T1, T2> > {
static inline qx_bool fromVariant(const QVariant & v, QPair<T1, T2> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename T> struct QxConvert_FromVariant< std::vector<T> > {
static inline qx_bool fromVariant(const QVariant & v, std::vector<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename T> struct QxConvert_FromVariant< std::list<T> > {
static inline qx_bool fromVariant(const QVariant & v, std::list<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename T> struct QxConvert_FromVariant< std::set<T> > {
static inline qx_bool fromVariant(const QVariant & v, std::set<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename T> struct QxConvert_FromVariant< boost::unordered_set<T> > {
static inline qx_bool fromVariant(const QVariant & v, boost::unordered_set<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename T> struct QxConvert_FromVariant< boost::unordered_multiset<T> > {
static inline qx_bool fromVariant(const QVariant & v, boost::unordered_multiset<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };
...
static inline qx_bool fromVariant(const QVariant & v, std::unordered_set<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename T> struct QxConvert_FromVariant< std::unordered_multiset<T> > {
static inline qx_bool fromVariant(const QVariant & v, std::unordered_multiset<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };
...
static inline qx_bool fromVariant(const QVariant & v, QVector<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename T> struct QxConvert_FromVariant< QList<T> > {
static inline qx_bool fromVariant(const QVariant & v, QList<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename T> struct QxConvert_FromVariant< QLinkedList<T> > {
static inline qx_bool fromVariant(const QVariant & v, QLinkedList<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename T> struct QxConvert_FromVariant< QFlags<T> > {
static inline qx_bool fromVariant(const QVariant & v, QFlags<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); t = QFlags<T>(QFlag(v.toInt())); return true; } };

template <typename Key, typename Value> struct QxConvert_FromVariant< std::map<Key, Value> > {
static inline qx_bool fromVariant(const QVariant & v, std::map<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename Key, typename Value> struct QxConvert_FromVariant< boost::unordered_map<Key, Value> > {
static inline qx_bool fromVariant(const QVariant & v, boost::unordered_map<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename Key, typename Value> struct QxConvert_FromVariant< boost::unordered_multimap<Key, Value> > {
static inline qx_bool fromVariant(const QVariant & v, boost::unordered_multimap<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };
...
static inline qx_bool fromVariant(const QVariant & v, std::unordered_map<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename Key, typename Value> struct QxConvert_FromVariant< std::unordered_multimap<Key, Value> > {
static inline qx_bool fromVariant(const QVariant & v, std::unordered_multimap<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };
...
static inline qx_bool fromVariant(const QVariant & v, QHash<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename Key, typename Value> struct QxConvert_FromVariant< QMultiHash<Key, Value> > {
static inline qx_bool fromVariant(const QVariant & v, QMultiHash<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename Key, typename Value> struct QxConvert_FromVariant< QMap<Key, Value> > {
static inline qx_bool fromVariant(const QVariant & v, QMap<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename Key, typename Value> struct QxConvert_FromVariant< QMultiMap<Key, Value> > {
static inline qx_bool fromVariant(const QVariant & v, QMultiMap<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename Key, typename Value> struct QxConvert_FromVariant< qx::QxCollection<Key, Value> > {
static inline qx_bool fromVariant(const QVariant & v, qx::QxCollection<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename T1> struct QxConvert_FromVariant< boost::tuple<T1> > {
static inline qx_bool fromVariant(const QVariant & v, boost::tuple<T1> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename T1, typename T2> struct QxConvert_FromVariant< boost::tuple<T1, T2> > {
static inline qx_bool fromVariant(const QVariant & v, boost::tuple<T1, T2> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename T1, typename T2, typename T3> struct QxConvert_FromVariant< boost::tuple<T1, T2, T3> > {
static inline qx_bool fromVariant(const QVariant & v, boost::tuple<T1, T2, T3> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename T1, typename T2, typename T3, typename T4> struct QxConvert_FromVariant< boost::tuple<T1, T2, T3, T4> > {
static inline qx_bool fromVariant(const QVariant & v, boost::tuple<T1, T2, T3, T4> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };
...
static inline qx_bool fromVariant(const QVariant & v, boost::tuple<T1, T2, T3, T4, T5> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };
...
static inline qx_bool fromVariant(const QVariant & v, boost::tuple<T1, T2, T3, T4, T5, T6> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };
...
static inline qx_bool fromVariant(const QVariant & v, boost::tuple<T1, T2, T3, T4, T5, T6, T7> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };
...
static inline qx_bool fromVariant(const QVariant & v, boost::tuple<T1, T2, T3, T4, T5, T6, T7, T8> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };
...
static inline qx_bool fromVariant(const QVariant & v, boost::tuple<T1, T2, T3, T4, T5, T6, T7, T8, T9> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };
...
static inline qx_bool fromVariant(const QVariant & v, std::tuple<T1> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename T1, typename T2> struct QxConvert_FromVariant< std::tuple<T1, T2> > {
static inline qx_bool fromVariant(const QVariant & v, std::tuple<T1, T2> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename T1, typename T2, typename T3> struct QxConvert_FromVariant< std::tuple<T1, T2, T3> > {
static inline qx_bool fromVariant(const QVariant & v, std::tuple<T1, T2, T3> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };

template <typename T1, typename T2, typename T3, typename T4> struct QxConvert_FromVariant< std::tuple<T1, T2, T3, T4> > {
static inline qx_bool fromVariant(const QVariant & v, std::tuple<T1, T2, T3, T4> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };
...
static inline qx_bool fromVariant(const QVariant & v, std::tuple<T1, T2, T3, T4, T5> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };
...
static inline qx_bool fromVariant(const QVariant & v, std::tuple<T1, T2, T3, T4, T5, T6> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };
...
static inline qx_bool fromVariant(const QVariant & v, std::tuple<T1, T2, T3, T4, T5, T6, T7> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };
...
static inline qx_bool fromVariant(const QVariant & v, std::tuple<T1, T2, T3, T4, T5, T6, T7, T8> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };
...
static inline qx_bool fromVariant(const QVariant & v, std::tuple<T1, T2, T3, T4, T5, T6, T7, T8, T9> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_FROM_VARIANT; } };
