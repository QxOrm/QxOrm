...
{ Q_UNUSED(index); return t.toString((! qx::cvt::detail::helper::QxConvertFormat::isValid(format)) ? QX_STR_CVT_QDATE_FORMAT : format); } };

template <> struct QxConvert_ToString< QTime > {
static inline QString toString(const QTime & t, const QString & format, int index)
{ Q_UNUSED(index); return t.toString((! qx::cvt::detail::helper::QxConvertFormat::isValid(format)) ? QX_STR_CVT_QTIME_FORMAT : format); } };
...
{ Q_UNUSED(index); return t.toString((! qx::cvt::detail::helper::QxConvertFormat::isValid(format)) ? QX_STR_CVT_QDATETIME_FORMAT : format); } };
...
{ Q_UNUSED(index); return ((! qx::cvt::detail::helper::QxConvertFormat::isValid(format)) ? QString::number(t) : QString().sprintf(qPrintable(format), t)); } };
