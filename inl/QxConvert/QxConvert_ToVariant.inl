...
static inline QVariant toVariant(const bool & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QVariant(t); } };
...
static inline QVariant toVariant(const int & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QVariant(t); } };
...
static inline QVariant toVariant(const double & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QVariant(t); } };
...
static inline QVariant toVariant(const unsigned int & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QVariant(t); } };
...
static inline QVariant toVariant(const QDate & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QVariant(t); } };

template <> struct QxConvert_ToVariant< QTime > {
static inline QVariant toVariant(const QTime & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QVariant(t); } };

template <> struct QxConvert_ToVariant< QDateTime > {
static inline QVariant toVariant(const QDateTime & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QVariant(t); } };

template <> struct QxConvert_ToVariant< QByteArray > {
static inline QVariant toVariant(const QByteArray & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QVariant(t); } };

template <> struct QxConvert_ToVariant< QString > {
static inline QVariant toVariant(const QString & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QVariant(t); } };

template <> struct QxConvert_ToVariant< QVariant > {
...
static inline QVariant toVariant(const QUuid & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QVariant(t.toString()); } };
...
static inline QVariant toVariant(const std::pair<T1, T2> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T1, typename T2> struct QxConvert_ToVariant< QPair<T1, T2> > {
static inline QVariant toVariant(const QPair<T1, T2> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T> struct QxConvert_ToVariant< std::vector<T> > {
static inline QVariant toVariant(const std::vector<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T> struct QxConvert_ToVariant< std::list<T> > {
static inline QVariant toVariant(const std::list<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T> struct QxConvert_ToVariant< std::set<T> > {
static inline QVariant toVariant(const std::set<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T> struct QxConvert_ToVariant< boost::unordered_set<T> > {
static inline QVariant toVariant(const boost::unordered_set<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T> struct QxConvert_ToVariant< boost::unordered_multiset<T> > {
static inline QVariant toVariant(const boost::unordered_multiset<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };
...
static inline QVariant toVariant(const std::unordered_set<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T> struct QxConvert_ToVariant< std::unordered_multiset<T> > {
static inline QVariant toVariant(const std::unordered_multiset<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };
...
static inline QVariant toVariant(const QVector<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T> struct QxConvert_ToVariant< QList<T> > {
static inline QVariant toVariant(const QList<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T> struct QxConvert_ToVariant< QLinkedList<T> > {
static inline QVariant toVariant(const QLinkedList<T> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T> struct QxConvert_ToVariant< QFlags<T> > {
static inline QVariant toVariant(const QFlags<T> & t, const QString & format, int index)
...
static inline QVariant toVariant(const std::map<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename Key, typename Value> struct QxConvert_ToVariant< boost::unordered_map<Key, Value> > {
static inline QVariant toVariant(const boost::unordered_map<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename Key, typename Value> struct QxConvert_ToVariant< boost::unordered_multimap<Key, Value> > {
static inline QVariant toVariant(const boost::unordered_multimap<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };
...
static inline QVariant toVariant(const std::unordered_map<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename Key, typename Value> struct QxConvert_ToVariant< std::unordered_multimap<Key, Value> > {
static inline QVariant toVariant(const std::unordered_multimap<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };
...
static inline QVariant toVariant(const QHash<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename Key, typename Value> struct QxConvert_ToVariant< QMultiHash<Key, Value> > {
static inline QVariant toVariant(const QMultiHash<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename Key, typename Value> struct QxConvert_ToVariant< QMap<Key, Value> > {
static inline QVariant toVariant(const QMap<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename Key, typename Value> struct QxConvert_ToVariant< QMultiMap<Key, Value> > {
static inline QVariant toVariant(const QMultiMap<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename Key, typename Value> struct QxConvert_ToVariant< qx::QxCollection<Key, Value> > {
static inline QVariant toVariant(const qx::QxCollection<Key, Value> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T1> struct QxConvert_ToVariant< boost::tuple<T1> > {
static inline QVariant toVariant(const boost::tuple<T1> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T1, typename T2> struct QxConvert_ToVariant< boost::tuple<T1, T2> > {
static inline QVariant toVariant(const boost::tuple<T1, T2> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T1, typename T2, typename T3> struct QxConvert_ToVariant< boost::tuple<T1, T2, T3> > {
static inline QVariant toVariant(const boost::tuple<T1, T2, T3> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T1, typename T2, typename T3, typename T4> struct QxConvert_ToVariant< boost::tuple<T1, T2, T3, T4> > {
static inline QVariant toVariant(const boost::tuple<T1, T2, T3, T4> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };
...
static inline QVariant toVariant(const boost::tuple<T1, T2, T3, T4, T5> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };
...
static inline QVariant toVariant(const boost::tuple<T1, T2, T3, T4, T5, T6> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };
...
static inline QVariant toVariant(const boost::tuple<T1, T2, T3, T4, T5, T6, T7> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };
...
static inline QVariant toVariant(const boost::tuple<T1, T2, T3, T4, T5, T6, T7, T8> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };
...
static inline QVariant toVariant(const boost::tuple<T1, T2, T3, T4, T5, T6, T7, T8, T9> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };
...
static inline QVariant toVariant(const std::tuple<T1> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T1, typename T2> struct QxConvert_ToVariant< std::tuple<T1, T2> > {
static inline QVariant toVariant(const std::tuple<T1, T2> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T1, typename T2, typename T3> struct QxConvert_ToVariant< std::tuple<T1, T2, T3> > {
static inline QVariant toVariant(const std::tuple<T1, T2, T3> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T1, typename T2, typename T3, typename T4> struct QxConvert_ToVariant< std::tuple<T1, T2, T3, T4> > {
static inline QVariant toVariant(const std::tuple<T1, T2, T3, T4> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };

template <typename T1, typename T2, typename T3, typename T4, typename T5> struct QxConvert_ToVariant< std::tuple<T1, T2, T3, T4, T5> > {
static inline QVariant toVariant(const std::tuple<T1, T2, T3, T4, T5> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };
...
static inline QVariant toVariant(const std::tuple<T1, T2, T3, T4, T5, T6> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };
...
static inline QVariant toVariant(const std::tuple<T1, T2, T3, T4, T5, T6, T7> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };
...
static inline QVariant toVariant(const std::tuple<T1, T2, T3, T4, T5, T6, T7, T8> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };
...
static inline QVariant toVariant(const std::tuple<T1, T2, T3, T4, T5, T6, T7, T8, T9> & t, const QString & format, int index)
{ Q_UNUSED(format); Q_UNUSED(index); return QX_CVT_DEFAULT_ARCHIVE_TO_VARIANT; } };
