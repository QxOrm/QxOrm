...
{
   QString tmp = qx::cvt::detail::QxConvert_ToString<std::string>::toString(t, "", 0);
   stream << tmp;
   return stream;
}
...
QDataStream & operator>> (QDataStream & stream, std::string & t)
{
   QString tmp;
   stream >> tmp;
   qx::cvt::detail::QxConvert_FromString<std::string>::fromString(tmp, t, "", 0);
   return stream;
}

QDataStream & operator<< (QDataStream & stream, const std::wstring & t)
{
   QString tmp = qx::cvt::detail::QxConvert_ToString<std::wstring>::toString(t, "", 0);
   stream << tmp;
   return stream;
}
...
QDataStream & operator>> (QDataStream & stream, std::wstring & t)
{
   QString tmp;
   stream >> tmp;
   qx::cvt::detail::QxConvert_FromString<std::wstring>::fromString(tmp, t, "", 0);
   return stream;
}
