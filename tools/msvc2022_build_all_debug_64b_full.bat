...
set QT_DIR=%QT6_0_MSVC2022_64B%
REM set BOOST_ROOT=%BOOST_ROOT_1_66%
...
cmake -G"Visual Studio 17 2022" -A x64 %QX_TEST_DIR% %CMAKE_OPTIONS%
cmake --build . --parallel --config %MSVC_CONFIG%
